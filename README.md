...
| lvodak    | Backend (auth, notification, database, playlist, ...), Android app (profile page) |
| jgoudema  | Frontend (artist, playlist, library, album) |
| ajossera  | Backend (web socket, database, music streaming, ...) |
...
│   ├── /auth/login     // ex  sub branches for related feature
│   └── /fix-bug-xxxx   // ex
│
