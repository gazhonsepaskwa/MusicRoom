...
import be.nalebrun.musicroom.di.NetworkModule;
import be.nalebrun.musicroom.di.RepositoryModule;
import be.nalebrun.musicroom.services.PlaybackService_GeneratedInjector;
...
public final class MusicRoomApp_HiltComponents {
  private MusicRoomApp_HiltComponents() {
  }
  ...
  public abstract static class SingletonC implements MusicRoomApp_GeneratedInjector,
  ...
  @Subcomponent(
      modules = {
          ...
          SocketViewModel_HiltModules.KeyModule.class,
  ...
  @Subcomponent(
      modules = {
          ...
          SocketViewModel_HiltModules.BindsModule.class,
